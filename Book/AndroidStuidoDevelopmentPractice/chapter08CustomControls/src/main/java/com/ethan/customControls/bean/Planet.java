package com.ethan.customControls.bean;
...
public class Planet {
    ...
    private static final int[] iconArray = {R.mipmap.shuixing, R.mipmap.jinxing, R.mipmap.diqiu,
            R.mipmap.huoxing, R.mipmap.muxing, R.mipmap.tuxing};
    private static final String[] nameArray = {"水星", "金星", "地球", "火星", "木星", "土星"};

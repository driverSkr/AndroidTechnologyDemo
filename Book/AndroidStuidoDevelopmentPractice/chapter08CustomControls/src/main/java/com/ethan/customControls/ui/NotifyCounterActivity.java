...
//计时消息的通知推送
/*包含计时器：setUsesChronometer；进度条：setProgress*/
public class NotifyCounterActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void sendCounterNotify(String title, String message) {
        ...
        // 创建一个跳转到活动页面的意图
        Intent cancelIntent = new Intent(this, CustomControlMainActivity.class);
        // 创建一个用于页面跳转的延迟意图
        PendingIntent deleteIntent = PendingIntent.getActivity(this,
                R.string.book_name,cancelIntent,PendingIntent.FLAG_UPDATE_CURRENT);
        // 创建一个通知消息的建造器

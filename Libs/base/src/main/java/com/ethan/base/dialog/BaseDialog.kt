...
class BaseDialog: AbsDialogFragment(), View.OnClickListener {

    private val keyController = "Controller"
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (null != savedInstanceState) {
            mController = (savedInstanceState.getParcelable<Controller>(keyController))!!
        }
    }
    ...
    override fun onSaveInstanceState(outState: Bundle) {
        outState.putParcelable(keyController, mController)
    ...
    override fun getGravity(): Int = mController.getGravity()

    override fun getDimAmount(): Float = mController.getDimAmount()

    override fun getDialogHeight(): Int = mController.getHeight()

    override fun getDialogWidth(): Int = mController.getWidth()

    override fun getFragmentTag(): String? = mController.getTag()

    override fun setCancelableOutside(b: Boolean) = mController.setCancelableOutside(b)

    override fun isCancelableOutside(): Boolean = mController.isCancelableOutside()

    override fun getLayoutRes(): Int = mController.getLayoutRes()

    override fun getDialogView(): View? = mController.getDialogView()

    override fun onClick(p0: View?) {
        mController.getOnViewClickListener()!!.onViewClick(view, this)
    }

    override fun getDialogAnimationRes(): Int = mController.getDialogAnimationRes()
